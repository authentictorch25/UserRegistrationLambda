...
namespace UserRegistrationProgram
{
    public class ValidEntry
    {
        ...
        /// </summary>
        public static Func<string, string, bool> Valid = (entry, pattern) => Regex.IsMatch(entry, pattern);
        /// <summary>
        ...
        public string ValidateFirstOrLastName()
        {
            ...
            while (true)
            {
                ...
                if (Valid(firstOrLastName, firstOrLastNamePattern))
                {
        ...
        public string ValidateMobileNumber()
        {
            ...
            while (true)
            {
                ...
                if (Valid(mobileNumber, mobileNumberPattern))
                {
        ...
        public string ValidatePassword()
        {
            ...
            while (true)
            {
                ...
                //IF valid password
                if (Valid(password, passwordPattern))
                {
